                    ...
                    <div style="border:solid thin #aaa;padding:10px;background-color: white;color:navy">
                        ...
                        <form method ="post" enctype="multipart/form-data">
                            ...
                            <?php
                                    ...
                                    {
                                        echo "Are you sure you want to Edit this post??<hr>";
                                        ...
                                        if(file_exists($ROW['image']))
                                        {
                                            ...
                                            echo '<textarea name="post" placeholder="Hello,write something *_^, happy,bad,angry,sad,all of it! You are a human, you have all of the emotions! No just happiness!^_*">'.$ROW['post'].'</textarea>';
                                            echo "<div><img src='$post_image' style='width:10%;' /></div>";
                                            echo '<input type="file" name="file" style="color:black">';
